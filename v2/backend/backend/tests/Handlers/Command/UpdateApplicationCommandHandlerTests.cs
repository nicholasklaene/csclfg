...
public class UpdateApplicationCommandHandlerTests : HandlerTestsBase
{
    ...
    [Fact]
    public async Task UpdateApplicationCommandHandler_ShouldNotReturnResponse_WhenApplicationDoesNotExist()
    {
        // Arrange
        var command = new UpdateApplicationCommand()
    ...
    [Fact]
    public async Task UpdateApplicationCommandHandler_ShouldNotReturnResponse_WhenNameOrSubdomainIsTaken()
    {
        // Arrange
        var command = new UpdateApplicationCommand()
            {Id = 1, Name = "taken", Subdomain = "taken"};
